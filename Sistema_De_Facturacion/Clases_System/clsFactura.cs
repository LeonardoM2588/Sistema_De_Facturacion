...
namespace Sistema_De_Facturacion.Clases_System
{
    class clsFactura
    {
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "Producto           Cantidad Precio Total";   // agrega lineas de  encabezados
        ...
        public class RawPrinterHelper
        {
            ...
            public static bool SendBytesToPrinter(string szPrinterName, IntPtr pBytes, Int32 dwCount)
            {
                ...
                di.pDocName = "Facturacion '"+DateTime.Now+"' '"+Control_System.DataUser.REALNAMEUSER+"'";
                di.pDataType = "RAW";
                //di.pOutputFile = @"C:\Users\EDWINLEONARDO\Documents\Facturacion";
